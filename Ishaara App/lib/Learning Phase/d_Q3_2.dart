...
class D_Q3_2 extends StatefulWidget {
  final String current_digit;
  final int current_level;

  const D_Q3_2({Key? key, required this.current_digit, required this.current_level}) : super(key: key);

  @override
  State<D_Q3_2> createState() => D_Q3_2State();
}

class D_Q3_2State extends State<D_Q3_2> with WidgetsBindingObserver {
  double _width = 300;
  double percent = 1;
  bool flag = true;
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: isCorrectAnswer
                  ...
                  try {
                    setState(() {
                      learning_digits_levels["${widget.current_level}"]++;
                    });
                    ...
                    if (learning_digits_levels["${widget.current_level}"] < 2) {

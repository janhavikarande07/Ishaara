...
class ExploreAlphabets_2 extends StatefulWidget {
  final String current_alphabet;

  const ExploreAlphabets_2({Key? key, required this.current_alphabet}) : super(key: key);

  @override
  State<ExploreAlphabets_2> createState() => ExploreAlphabets_2State();
}

class ExploreAlphabets_2State extends State<ExploreAlphabets_2> with WidgetsBindingObserver {
  bool flag = true;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          if (confidence > 0.8 &&
              (label.toLowerCase() == widget.current_alphabet.toLowerCase()
                  || (label.toLowerCase() == "b" && widget.current_alphabet.toLowerCase() == "c")
                  || (label.toLowerCase() == "1" && widget.current_alphabet.toLowerCase() == "i")
                  || (label.toLowerCase() == "2" && widget.current_alphabet.toLowerCase() == "v"))) {
